            ...
            {PLANS.map((plan) => {
              ...
              return (
                ...
                >
                  ...
                  {isTrimestral && (
                    <div className="absolute -top-3 left-6 bg-gradient-to-r from-amber-500 to-yellow-400 text-black text-[9px] font-black uppercase tracking-widest px-3 py-1 shadow-md flex items-center gap-1" style={{ borderRadius: '4px' }}>
                  ...
                  <div className="flex items-center gap-3.5 sm:gap-5 flex-1 pr-4">
                    ...
                    <div className="flex flex-col justify-center">
                      ...
                      <span className="text-[9px] sm:text-[10px] text-zinc-500 font-bold uppercase tracking-widest mt-0.5">
                        {plan.months} {plan.months === 1 ? 'MÊS' : 'MESES'} DE ACOMPANHAMENTO
                      </span>
                    </div>
                  </div>
